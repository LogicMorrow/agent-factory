...
3. **`knowledge-base/lessons.jsonl` tail 10** — czy ostatnie lessons zawierają wzorce powiązane z bieżącym problemem.
...
| `knowledge-base/solution-memory-schema.json` | Schemat walidacji linii indeksu + frontmatter md |
| `knowledge-base/docs/solution-memory/adr/001-model-solution-memory.md` | ADR — wybór md+index (opcja C) + reguła scope |
