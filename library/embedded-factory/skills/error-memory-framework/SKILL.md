...
Gdy wpis ma `severity: HIGH` — `mistake-recorder` appenduje ROWNIEZ do `.claude/knowledge-base/lessons.jsonl`:
...
- Kazda inna sciezka (np. `.claude/knowledge-base/`, `library/`, `/tmp/`, `~/.claude/`)
...
- **`.claude/knowledge-base/plans/2026-05-06--learning-loop.md`** — E1 = ten skill, E2/E3/E6/E7 = konsumenci
