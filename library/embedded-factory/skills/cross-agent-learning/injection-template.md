...
2. Czytaj 3 najnowsze reflections:
   - `Glob: .claude/knowledge-base/reflections/{this-agent-name}*.md` (sort desc, head 3)
...
3. Czytaj `.claude/knowledge-base/lessons.jsonl` tail 20
...
2. Czytaj 3 najnowsze reflections:
   - `Glob: .claude/knowledge-base/reflections/code-implementer*.md` (sort desc, head 3)
   - `Read` kazdy znaleziony plik — skip jesli 0 wynikow
3. Czytaj `.claude/knowledge-base/lessons.jsonl` — tail 20 wierszy
