...
# Workflow
1. **Wczytaj brief z wywiadu** — przeczytaj najnowszy plik z `knowledge-base/interviews/` (lub podaną ścieżkę). Brief ma sekcję "zakres wiedzy", "trigger", "reużywalność". **Bez briefu — przerwij i odeślij do `requirements-interviewer`.**
