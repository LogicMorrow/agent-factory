...
2. Czytaj 3 najnowsze reflections (sort desc) — szczególnie poprzednie pattern-detector runs (`knowledge-base/reflections/pattern-detector*.md`)
3. Czytaj WSZYSTKIE poprzednie pattern files w `knowledge-base/patterns/` — żeby NIE re-detect tego samego patternu
...
4. **Existing patterns** — `knowledge-base/patterns/*.md` (NIE re-detect)
...
**Output per pattern:** structured markdown w `knowledge-base/patterns/<date>-<pattern-slug>.md`:
...
`knowledge-base/patterns/<date>-summary.md`:
...
```json
{
  ...
  "min_occurrences": 3,
  "patterns_detected": 5,
  "patterns_paths": ["knowledge-base/patterns/2026-05-XX-...", ...],
  "summary_path": "knowledge-base/patterns/2026-05-XX-summary.md",
  "actionable_count": 3,
  "noise_filtered": 2
}
```
...
Activity-log:
```bash
echo '{"ts":"<ISO>","actor":"pattern-detector","action":"pattern_detected","artifact":"knowledge-base/patterns/<date>/","status":"ok","notes":"N patterns, X actionable","actual_token_cost":{"input":<>,"output":<>,"total":<>,"model":"opus","estimation_method":"proxy"}}' >> knowledge-base/activity-log.jsonl
```
...
- ❌ **Re-detect tego samego patternu** — Krok 0 cz incident knowledge-base/patterns/ existing
...
- **Nie generuje paczek**
- **Nie modyfikuje pliki w knowledge-base/** poza `knowledge-base/patterns/` i activity-log
...
Files:
  - knowledge-base/patterns/2026-05-XX-speculative-agents.md
  - knowledge-base/patterns/2026-05-XX-fixtures-missing.md
  - knowledge-base/patterns/2026-05-XX-schema-drift.md
  - knowledge-base/patterns/2026-05-XX-summary.md
